final List<CardViewModel> demoCards = [
  new CardViewModel(
    backdropAssetPath: 'assets/images/van_on_beach.jpg',
    address: '10TH STREET',
    minHeightInFeet: 2,
    maxHeightInFeet: 3,
    tempInDegrees: 65.1,
  ...
  new CardViewModel(
    backdropAssetPath: 'assets/images/dusk_waves.jpg',
  ...
  new CardViewModel(
    backdropAssetPath: 'assets/images/board_walk.jpg',
    address: 'BELLS BEACH',
    minHeightInFeet: 3,
    maxHeightInFeet: 4,
    tempInDegrees: 61.0,
  ...
  new CardViewModel(
    backdropAssetPath: 'assets/images/italy08.jpg',
    address: 'Italy',
    minHeightInFeet: 0,
    maxHeightInFeet: 8,
    tempInDegrees: 99.0,
  ...
  new CardViewModel(
    backdropAssetPath: 'assets/images/italy05.jpg',
    address: 'Italy',
    minHeightInFeet: 0,
    maxHeightInFeet: 8,
    tempInDegrees: 99.0,
  ...
  new CardViewModel(
    backdropAssetPath: 'assets/images/italy06.jpg',
    address: 'Italy',
    minHeightInFeet: 0,
    maxHeightInFeet: 8,
    tempInDegrees: 99.0,
