...
const double contentStartSize = 100;
...
class _ExhibitionBottomSheetState extends State<ExhibitionBottomSheet>
  ...
  double get contentSize => lerp(contentStartSize,iconEndSize);
    ...
    return Positioned(
      ...
      child: AnimatedOpacity(
        ...
        child: Container(
          ...
          padding: EdgeInsets.only(left: height).add(EdgeInsets.all(10.0)),
...
final List<Event> events = [
  ...
  Event('italy08.jpg', 'Dawan District Guangdong Hong Kong', '4.28-31'),
];
